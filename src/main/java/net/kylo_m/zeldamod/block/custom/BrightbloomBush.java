...
public class BrightbloomBush extends PlantBlock implements Fertilizable {
    ...
    public BrightbloomBush(AbstractBlock.Settings settings) {
        super(settings);
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(ModItems.BRIGHTBLOOM_SEEDS);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (i > 2) {
            ...
            net.minecraft.block.SweetBerryBushBlock.dropStack(world, pos, new ItemStack(ModItems.BRIGHTBLOOM_SEEDS, j + (bl ? 1 : 0)));
