...
public class SpicyPepperBush extends PlantBlock implements Fertilizable {
    ...
    public SpicyPepperBush(AbstractBlock.Settings settings) {
        super(settings);
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(ModItems.SPICY_PEPPER);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (i > 2) {
            ...
            net.minecraft.block.SweetBerryBushBlock.dropStack(world, pos, new ItemStack(ModItems.SPICY_PEPPER, j + (bl ? 1 : 0)));
