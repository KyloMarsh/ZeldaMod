...
public class BrightbloomFlame extends AbstractSlowingParticle {
    BrightbloomFlame(ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
    ...
    public static class SmallFactory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            BrightbloomFlame flameParticle = new BrightbloomFlame(clientWorld, d, e, f, g, h, i);
